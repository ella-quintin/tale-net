        ...
        <>
            ...
            <div className='bg-black min-h-screen flex flex-col items-center justify-center py-8 pt-24'>
                <div className='flex  bg-black justify-center items-center mt-28 p-14 gap-16'>
                    <img src={lsix} className='w-96 rounded-xl' alt="" />
                    <div className='flex flex-col'>
                        <h3 className='text-5xl text-white font-bold mb-3'>About Us</h3>
                        <p className='text-white text-xl font-light'>Tale-net is a combination of  "talent" and "connect" in a unique way. It suggests a connection or network of talented individuals, and the "tale" prefix adds a storytelling element.
